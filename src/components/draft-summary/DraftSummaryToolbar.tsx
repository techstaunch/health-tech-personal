...
const DraftSummaryToolbar = ({ editor }: DraftSummaryToolbarProps) => {
    return (
        <div className="px-4 py-1.5 border-b bg-muted/20 flex items-center justify-center gap-1 overflow-x-auto no-scrollbar sticky top-[61px] z-10 backdrop-blur-md">
